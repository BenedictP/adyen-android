...
class PaymentMethodsListViewModel(
    ...
    private fun setupPaymentMethods(paymentMethods: Map<Int, PaymentMethod>) {
        ...
        paymentMethods.keys.sorted().forEach { index ->
            val paymentMethod = paymentMethods[index] ?: return@forEach
